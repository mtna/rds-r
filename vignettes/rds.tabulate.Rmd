...
ggplot(tabulation@records, aes(
  x = STATE,
  y = as.numeric(as.character(percent)),
  color = STATE
)) +
  geom_bar(stat = "identity", fill = "white") + 
...
# Make the plot
ggplot(tabulation@records, aes(x=STATE, y=as.numeric(as.character(percent)), fill=HHT)) + geom_bar(stat="identity") +
  scale_y_continuous(name = "Percent") + 
  facet_grid(tabulation@records$SEX) +
