...
dataSet <- select("http://localhost:8080/rds/api/query/","anes","anes1948aws",metadata=TRUE, rowLimit=10, autoPage=FALSE, colLimit=10)
variablesMetadata <- get.variables("http://localhost:8080/rds/api/catalog/","anes","anes1948aws",cols="$respondent",columnLimit=10)
...
dataSet <- select("http://localhost:8080/rds/api/query/","anes","anes1948aws", colLimit = 10, rowLimit = 10, metadata = TRUE, inject=TRUE)
data <- dataSet@data
